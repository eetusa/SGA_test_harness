public class SGA_driver {
    ...
    public SGA_driver(double m_p, double c_p, boolean i_cpm, int pop_size, int chrom_len, String goal, int amount_of_runs, int nbr){
        MUTATION_PROB = m_p;
        CROSSOVER_PROB = c_p;
    ...
    public void run_once(int run_nro) throws CloneNotSupportedException {
        ...
        sga = new SGA(POPULATION_SIZE, GOAL);
